  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        {/* In a real app, this might link to the coordinator's "Add Student" page */}
      </div>
              ...
              {isLoading ? (
                ...
                studentList.map((student) => (
                  <tr key={student.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{new Date(student.enrollmentDate).toLocaleDateString()}</td>
